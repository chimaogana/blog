            ...
            {{ csrf_field()}}
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="{{$post->subtitle}}" class="form-control" id="subtitle" placeholder="subtitle" name="subtitle">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Post Slug</label>
                  <input type="text" value="{{$post->slug}}" class="form-control" id="slug" placeholder="slug" name="slug">
                </div></div>
